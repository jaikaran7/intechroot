...
import { COMPANY_COPYRIGHT, COMPANY_NAME_LOGO } from "../constants/companyBrand";
    ...
    <footer className="bg-[#eceef1] dark:bg-[#000615] w-full border-t border-[#c4c6ce]/15">
      <div className="max-w-7xl mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
        <div className="space-y-6">
          <div className="text-lg font-bold text-[#0B1F3A] dark:text-white font-headline">{COMPANY_NAME_LOGO}</div>
