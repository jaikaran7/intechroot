...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center pt-24 md:pt-28 lg:pt-32 pb-16 md:pb-24 overflow-hidden hero-gradient">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20 items-center">
          <div className="lg:col-span-7 space-y-6 md:space-y-8 lg:space-y-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 lg:gap-6 pt-2 lg:pt-6">
              ...
              <Button
                className="px-8 md:px-10 py-4 md:py-5 rounded-full border border-white/20 text-white font-headline font-bold text-[11px] uppercase tracking-[0.25em] backdrop-blur-md hover:bg-white/5 transition-all"
