...
import "./success.css";
import { clearApplicantSession, getApplicantSessionId } from "../../applicant/applicantSession";
import UpcomingInterviews from "../../applicant/components/UpcomingInterviews";
import {
...
export default function SuccessPage() {
  ...
  const handleUploadClick = (rowKey) => {
    ...
    const templateRow = REQUIRED_DOCUMENT_ROWS.find((r) => r.key === rowKey);
  ...
  const onFileSelected = (event) => {
    ...
    const row = REQUIRED_DOCUMENT_ROWS.find((r) => r.key === key);
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left">
                ...
                <tbody className="divide-y divide-outline-variant/10">
                  {REQUIRED_DOCUMENT_ROWS.map((row) => {
